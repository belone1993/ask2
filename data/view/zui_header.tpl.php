...
<html lang="zh-cn">
  <? global $starttime,$querynum;$mtime = explode(' ', microtime());$runtime=number_format($mtime['1'] + $mtime['0'] - $starttime,6); $setting=$this->setting;$user=$this->user;$headernavlist=$this->nav;$regular=$this->regular;$toolbars="'".str_replace(",", "','", $setting['editor_toolbars'])."'"; $statistics=$this->fromcache('statistics'); ?><head>
    ...
    <link href="<?=SITE_URL?>css/dist/css/normalize.css" rel="stylesheet">
    <!-- zui -->
    <link href="<?=SITE_URL?>css/dist/css/zui.min.css" rel="stylesheet">
    <link href="dist/css/animate.min.css" rel="stylesheet">

    <link href="<?=SITE_URL?>css/dist/css/main.css" rel="stylesheet">
    <!-- jQuery -->
...
<span class="b_home2"> <a href="<?=SITE_URL?>"><i class="icon icon-home font-18 color-white"></i>问答首页</a></span>
</p>
      <p class="b_p1_1">
...
<span class="b_span6 color-white" id="topSpan2"><a class="color-white" href="<?=SITE_URL?>message/personal.html">消息<i class="icon icon-envelope mar-ly-03 text-danger msg-count"></i></a></span>

<div class="b_help">
<span class="b_span8"> 
<a class="dropdown-toggle color-white " data-toggle="dropdown" href="javascript:void(0);">管理 <i class="icon icon-bars "></i></a>
 ...
 <ul class="dropdown-menu pull-right">
         ...
         <? if($user['groupid']<=3) { ?>          <li class="b-r-line"><a href="<?=SITE_URL?>index.php?admin_main"><i class="icon icon-diamond text-success mar-ly-05"></i>后台管理</a></li>
            ...
            <li class="b-r-line"><a href="<?=SITE_URL?>favorite/default.html"><i class="icon icon-asterisk text-success mar-ly-05"></i>我的收藏</a></li>
             ...
             <li><a href="javascript:void(0);" id="loginout" ><i class="icon icon-signout text-success mar-ly-05"></i>退出网站</a></li>
        </ul>
...
<span class="b_span7"><a href="<?=SITE_URL?>user/login.html"><i class="icon icon-user font-18 color-white"></i></a></span>
<div class="b_help">
<span class="b_span8"> 
<a class="dropdown-toggle color-white "  href="javascript:login();">管理 <i class="icon icon-bars "></i></a>
...
<!-- 搜索和logo -->
<div class="search-part bg-white">
<div class="container  ">
<div class="row">
  <div class="col-md-5">
   ...
   <? } else { ?> 
    <img src="<?=SITE_URL?>css/soso/logo.png">
   <? } ?> 
...
<button type="submit"  id="search_btn" class="btnup" ><i class="icon icon-search color-white font-20"></i>搜 索</button>
