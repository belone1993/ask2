...
<div class="note ">
<h1 class="font-18"><?=$note['title']?> </h1>
   <div class="time mar-t-1 text-center">
...
<hr>
   <form class="form-horizontal mar-b-1" name="commentForm" action="<?=SITE_URL?>note/addcomment.html" method="post">
          ...
          <label class="col-md-2 control-label text-left">评论内容</label>
          <div class="col-md-10">
               <div class="your-answer">
                    <script type="text/plain" id="content" name="content" style="height: 122px;width:100%;"></script>
                    <script type="text/javascript">UE.getEditor('content', UE.utils.extend({toolbars:[[<?=$toolbars?>]]}));</script>
                       ...
                       <div class="form-group">
          <label class="col-md-2 control-label text-left">验证码</label>
          <div class="col-md-4">
        ...
        <div class="form-group">
          <div class="col-md-offset-2 col-md-10">
             <input type="submit" id="submit" class="btn btn-success width-120" value="保存" data-loading="稍候..."> 
