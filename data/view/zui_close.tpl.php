<? if(!defined('IN_ASK2')) exit('Access Denied'); include template('header'); include template('banner'); $adlist = $this->fromcache("adlist"); ?><script src="<?=SITE_URL?>js/editor/ueditor.config.js" type="text/javascript"></script> 
...
<div class="col-sm-2 ">
    <div class="card border_none">
        ...
        <img data-toggle="lightbox"  data-group="image-group-1" data-image="<?=SITE_URL?>upload/code.jpg" data-caption="扫一扫图片中的二维码"
...
<!--中间区域展示-->
<div class="col-sm-7 b-l-line b-r-line">
...
<div class="row question-des">
    <div class="col-sm-12">
         <? echo replacewords($question['description']);     ?>    </div>
     <div class="col-sm-12">
     <ul class="nav">
...
<div class="comment">
    ...
    <div class="content">
        ...
        <a href="<?=SITE_URL?>?u-<?=$answer['authorid']?>.html" class="author"><strong><? echo cutstr($answer['author'],7,''); ?></strong></a>
...
<? if(is_array($followerlist)) { foreach($followerlist as $follower) { ?>
         <div class="col-sm-3 mar-t-05">
                <a href="<?=SITE_URL?>?u-<?=$follower['followerid']?>.html" target="_blank"><img height="45" width="45" class="img-circle" src="<?=$follower['avatar']?>" onmouseover="pop_user_on(this, '<?=$follower['followerid']?>', 'image_follow');"  onmouseout="pop_user_out();"/></a>
                 </div>
...
<div class="tiwening mar-t-05">
    ...
    <div class="right_box_title clearfix">
        ...
        <a class="pull-right mar-ly-05"  href="<?=SITE_URL?>?c-all/1.html">
            更多
        </a>
    </div>
...
<? if(is_array($nosolvelist)) { foreach($nosolvelist as $index => $question_left) { ?>
                ...
                <div class="right">
                    ...
                    <div class="right_bottom">
                        <strong class="otw clear"><i>Q:</i><a title="<?=$question_left['title']?>" target="_blank"
                                                              href="<?=SITE_URL?>?q-<?=$question_left['id']?>.html"><?=$question_left['title']?></a></strong>
